...
function App() {
  ...
  const staticData = [
    {
      "category": "IT",
      "description": "я Software Engineer в продуктовій компанії і в такий буремний, для джунів, час знайов свою першу роботу в IT менше ніж за місяць, тому, я гадаю, маю чим поділитися",
      "items": [
        {
